...
export default function FinancialExtractions() {
  ...
  return (
    <FinancialPageLayout
      title="Financial Overview: Extraction History"
      subtitle="High-level status for processed sources in financial extraction."
          ...
          <div class="card bg-base-200">
            <div class="card-body">
              ...
              <p class="text-sm text-base-content/70">
                Trigger a financial extraction to start capturing transactions
