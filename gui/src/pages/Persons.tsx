...
import type { Person, PersonsResponse } from "../api-types/types";
                  ...
                  <tbody>
                    ...
                    >
                      <For each={persons()}>
                        {(person) => (
                          <tr class="hover">
                            <td class="font-medium text-sm">{person.name}</td>
                            <td class="text-xs">{person.email || "-"}</td>
                            <td class="text-xs">{person.phone || "-"}</td>
                          </tr>
                        )}
                      </For>
                    </Show>
