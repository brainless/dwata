 ...
 */
export type CreateImapCredentialRequest = {
  identifier: string;
  username: string;
  password: string;
 ...
 */
export type ImapCredentialMetadata = {
  id: bigint;
  identifier: string;
  username: string;
  settings: ImapAccountSettings;
 ...
 */
export type CreateLocalFileCredentialRequest = {
  identifier: string;
...
export type DownloadProgress = {
  ...
  estimated_completion_secs: bigint | null;
};
 ...
 */
export type ImapDownloadState = {
  folders: Array<ImapFolderStatus>;
  sync_strategy: ImapSyncStrategy;
...
export type ImapSyncStrategy =
  | "full-sync"
  | "inbox-only"
  | { "selected-folders": Array<string> }
  | "new-only"
 ...
 */
export type CloudStorageDownloadState = {
  root_path: string;
  directories: Array<DirectoryStatus>;
...
export type ExtractedEntity =
  ...
  | { type: "Task"; data: ExtractedTask }
  | { type: "Event"; data: ExtractedEvent }
  | { type: "Contact"; data: ExtractedContact }
  | { type: "Location"; data: ExtractedLocation }
  | { type: "Company"; data: ExtractedCompany }
  | { type: "Position"; data: ExtractedPosition };
...
export type ExtractionProgress = {
  ...
  extracted_entities: bigint;
  failed_items: bigint;
  events_extracted: bigint;
  contacts_extracted: bigint;
  companies_extracted: bigint;
  positions_extracted: bigint;
  percent_complete: number;
};
...
export type ExtractionSourceConfig =
  | {
      ...
      config: {
        email_ids: Array<bigint> | null;
        attachment_types: Array<string>;
        status_filter: AttachmentExtractionFilter;
      };
    }
  | { type: "LocalFile"; config: { file_path: string; content_type: string } }
  | {
      type: "LocalArchive";
      config: {
        archive_path: string;
        archive_type: ArchiveType;
        files_to_process: Array<string>;
      };
    };

export type AttachmentExtractionFilter =
  | "pending"
  | "pending-and-failed"
  | "all";
 ...
 */
export type CreateExtractionJobRequest = {
  source_type: ExtractionSourceType;
  extractor_type: ExtractorType;
  source_config: ExtractionSourceConfig;
};
...
export type Contact = {
  ...
  merged_into_contact_id: bigint | null;
  created_at: bigint;
  updated_at: bigint;
};
...
export type FinancialHealth = {
  ...
  recent_transactions: Array<FinancialTransaction>;
  upcoming_bills: Array<FinancialTransaction>;
